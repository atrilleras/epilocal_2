...
library(openxlsx)
rm(list=ls())
source("replicar_nature/utils/process_covariates.r")
...
datos <-loadWorkbook("replicar_nature/data/datos_nature.xlsx")
...
countries <- data.frame(Regions=c("Denmark","Italy","Germany","Spain","United_Kingdom",
